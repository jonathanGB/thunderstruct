...
print("Dot shape: {}\nDot vec time: {}s ({}%) - {} times\nDot mat time: {}s ({}%) - {} times".format(datdot.shape, datdot.vectime, datdot.vectime/total*100, datdot.veccount, datdot.mattime, datdot.mattime/total*100, datdot.matcount))
